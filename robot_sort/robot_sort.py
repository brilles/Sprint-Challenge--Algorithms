class SortingRobot:
    ...
    def sort(self):
        ...
        # swap None for 0th index item
        self.swap_item() 

        while True:

            # while robot can still move right (ie not at end)
            while self.can_move_right() == True: 

                # keep moving right
                self.move_right()

                # if the held item's value is greater, swap --> finding the smallest element
            ...
            # swap smallest for none
            self.swap_item()

            # if we can still move right, do so, and swap item, else, we are done sorting
